...
export async function generateMetadata(): Promise<Metadata> {
  const service = getServiceBySlug("packing-services");
  if (!service) return {};
  return {
    title: service.metaTitle,
    description: service.metaDescription,
    keywords: service.keywords,
    alternates: { canonical: `${SITE.url}/services/packing-services` },
    openGraph: {
      title: service.metaTitle,
      description: service.metaDescription,
      url: `${SITE.url}/services/packing-services`,
    },
  };
}
...
export default function ServicePage() {
  ...
  const schemas = [
    ...
    buildBreadcrumbSchema([
      ...
      { name: service.shortTitle, url: `${SITE.url}/services/packing-services` },
    ]),
