...
export async function generateMetadata(): Promise<Metadata> {
  const service = getServiceBySlug("house-clearance");
  if (!service) return {};
  return {
    title: service.metaTitle,
    description: service.metaDescription,
    keywords: service.keywords,
    alternates: { canonical: `${SITE.url}/services/house-clearance` },
    openGraph: {
      title: service.metaTitle,
      description: service.metaDescription,
      url: `${SITE.url}/services/house-clearance`,
    },
  };
}
...
export default function ServicePage() {
  ...
  const schemas = [
    ...
    buildBreadcrumbSchema([
      ...
      { name: service.shortTitle, url: `${SITE.url}/services/house-clearance` },
    ]),
