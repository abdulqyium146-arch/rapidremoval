...
export async function generateMetadata(): Promise<Metadata> {
  const service = getServiceBySlug("student-moves");
  if (!service) return {};
  return {
    title: service.metaTitle,
    description: service.metaDescription,
    keywords: service.keywords,
    alternates: { canonical: `${SITE.url}/services/student-moves` },
    openGraph: {
      title: service.metaTitle,
      description: service.metaDescription,
      url: `${SITE.url}/services/student-moves`,
    },
  };
}
...
export default function ServicePage() {
  ...
  const schemas = [
    ...
    buildBreadcrumbSchema([
      ...
      { name: service.shortTitle, url: `${SITE.url}/services/student-moves` },
    ]),
