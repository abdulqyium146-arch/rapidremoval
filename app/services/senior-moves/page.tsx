...
export async function generateMetadata(): Promise<Metadata> {
  const service = getServiceBySlug("senior-moves");
  if (!service) return {};
  return {
    title: service.metaTitle,
    description: service.metaDescription,
    keywords: service.keywords,
    alternates: { canonical: `${SITE.url}/services/senior-moves` },
    openGraph: {
      title: service.metaTitle,
      description: service.metaDescription,
      url: `${SITE.url}/services/senior-moves`,
    },
  };
}
...
export default function ServicePage() {
  ...
  const schemas = [
    ...
    buildBreadcrumbSchema([
      ...
      { name: service.shortTitle, url: `${SITE.url}/services/senior-moves` },
    ]),
