...
export async function generateMetadata(): Promise<Metadata> {
  const service = getServiceBySlug("man-and-van");
  if (!service) return {};
  return {
    title: service.metaTitle,
    description: service.metaDescription,
    keywords: service.keywords,
    alternates: { canonical: `${SITE.url}/services/man-and-van` },
    openGraph: {
      title: service.metaTitle,
      description: service.metaDescription,
      url: `${SITE.url}/services/man-and-van`,
    },
  };
}
...
export default function ServicePage() {
  ...
  const schemas = [
    ...
    buildBreadcrumbSchema([
      ...
      { name: service.shortTitle, url: `${SITE.url}/services/man-and-van` },
    ]),
