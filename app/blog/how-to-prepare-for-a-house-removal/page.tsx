...
import { CheckCircle, ArrowRight, Phone, Clock, ExternalLink, Truck } from "lucide-react";
          ...
          <div className="flex items-start gap-4 bg-brand-neutral rounded-2xl p-5 border border-slate-100">
            ...
            <div>
              ...
              <p className="text-brand-muted text-xs mt-2 leading-relaxed">
                ...
                moves across the West Midlands. The checklist reflects the preparation steps our
                professional team recommends to every customer before moving day.
              </p>
