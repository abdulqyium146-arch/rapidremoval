...
export async function generateMetadata(): Promise<Metadata> {
  const area = getAreaBySlug("tettenhall");
  if (!area) return {};
  return {
    title: area.metaTitle,
    description: area.metaDescription,
    keywords: area.keywords,
    alternates: { canonical: `${SITE.url}/areas/tettenhall` },
    openGraph: {
      title: area.metaTitle,
      description: area.metaDescription,
      url: `${SITE.url}/areas/tettenhall`,
    },
  };
}
...
export default function AreaPage() {
  ...
  const schemas = [
    ...
    buildBreadcrumbSchema([
      ...
      { name: area.name, url: `${SITE.url}/areas/tettenhall` },
    ]),
